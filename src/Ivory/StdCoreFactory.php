...
class StdCoreFactory implements ICoreFactory
{
    public function createGlobalTypeRegister(): TypeRegister
    {
        ...
        $reg->addTypeRecognitionRule(Value\Decimal::class, 'pg_catalog', 'numeric');
        $reg->addTypeRecognitionRule(Value\Date::class, 'pg_catalog', 'date');
        $reg->addTypeRecognitionRule(Value\Time::class, 'pg_catalog', 'time');
        $reg->addTypeRecognitionRule(Value\TimeTz::class, 'pg_catalog', 'timetz');
        $reg->addTypeRecognitionRule(Value\Timestamp::class, 'pg_catalog', 'timestamp');
        $reg->addTypeRecognitionRule(Value\TimestampTz::class, 'pg_catalog', 'timestamptz');
        $reg->addTypeRecognitionRule(Value\TimeInterval::class, 'pg_catalog', 'interval');
        $reg->addTypeRecognitionRule(Value\FixedBitString::class, 'pg_catalog', 'bit');
        $reg->addTypeRecognitionRule(Value\VarBitString::class, 'pg_catalog', 'varbit');
        $reg->addTypeRecognitionRule(Value\Json::class, 'pg_catalog', 'json');
        $reg->addTypeRecognitionRule(Value\XmlContent::class, 'pg_catalog', 'xml');
        $reg->addTypeRecognitionRule(Value\XmlDocument::class, 'pg_catalog', 'xml');
        ...
        $reg->addTypeRecognitionRule(Value\Point::class, 'pg_catalog', 'point');
        $reg->addTypeRecognitionRule(Value\Line::class, 'pg_catalog', 'line');
        $reg->addTypeRecognitionRule(Value\LineSegment::class, 'pg_catalog', 'lseg');
        $reg->addTypeRecognitionRule(Value\Box::class, 'pg_catalog', 'box');
        $reg->addTypeRecognitionRule(Value\Path::class, 'pg_catalog', 'path');
        $reg->addTypeRecognitionRule(Value\Polygon::class, 'pg_catalog', 'polygon');
        $reg->addTypeRecognitionRule(Value\Circle::class, 'pg_catalog', 'circle');
        $reg->addTypeRecognitionRule(Value\NetAddress::class, 'pg_catalog', 'inet');
        $reg->addTypeRecognitionRule(Value\MacAddr::class, 'pg_catalog', 'macaddr');
        $reg->addTypeRecognitionRule(Value\Money::class, 'pg_catalog', 'money');
        $reg->addTypeRecognitionRule(Value\PgLogSequenceNumber::class, 'pg_catalog', 'pg_lsn');
        $reg->addTypeRecognitionRule(Value\TxIdSnapshot::class, 'pg_catalog', 'txid_snapshot');
        $reg->addTypeRecognitionRule(Value\TextSearchVector::class, 'pg_catalog', 'tsvector');
        $reg->addTypeRecognitionRule(Value\TextSearchQuery::class, 'pg_catalog', 'tsquery');
