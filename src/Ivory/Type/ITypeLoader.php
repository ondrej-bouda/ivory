...
interface ITypeLoader
{
	 ...
	 * @param \Ivory\Connection\IConnection $connection connection above which the type is to be loaded
	 * @return IType|null the corresponding type object, or
	 *                    <tt>null</tt> if this type loader does not recognize the given type
	 */
	function loadType($typeName, $schemaName, \Ivory\Connection\IConnection $connection);
}
