...
class DecimalTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testFromNumber()
	{
		...
		$this->assertSame('1.450000000000000000000000000000000000000000', Decimal::fromNumber('1.4499999999999999999999999999999999999999999', 42)->toString());
	...
	public function testPow()
	{
		...
		$this->assertSame('-2196865363902893118253653.9788273777733597', Decimal::fromNumber('-74.5497890')->pow(13)->toString());
		$this->assertSame('344073703240820000000000' /* '344073703240822219557582.4422472'*/,
